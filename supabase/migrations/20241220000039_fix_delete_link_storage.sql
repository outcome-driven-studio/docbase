-- Fix delete_link function to remove invalid storage.delete_object call
-- Storage deletion should be handled client-side via the Supabase client
...
BEGIN
  ...
  -- Delete the link
  -- Note: Storage file deletion is handled client-side via the Supabase storage API
